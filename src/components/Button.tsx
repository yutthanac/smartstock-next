...
const variantStyles: Record<NonNullable<ButtonProps['variant']>, string> = {
  ...
  secondary:
    'bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/60 active:scale-[0.98]',
  outline:
    'bg-white hover:bg-slate-50 text-slate-700 border border-slate-200/90 shadow-2xs active:scale-[0.98]',
  ghost:
    'bg-transparent hover:bg-slate-100 text-slate-600 hover:text-slate-900 border border-transparent active:scale-[0.98]',
  danger:
    'bg-rose-600 hover:bg-rose-700 text-white shadow-xs border border-transparent active:scale-[0.98]',
};

const sizeStyles: Record<NonNullable<ButtonProps['size']>, string> = {
  sm: 'h-9 px-3 text-xs rounded-xl gap-1.5 font-medium',
  md: 'h-10 px-4 text-xs sm:text-sm rounded-xl gap-2 font-medium',
