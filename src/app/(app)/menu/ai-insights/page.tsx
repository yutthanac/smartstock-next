        ...
        {activeTab === 'existing' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {displayRecommendations.map((item, idx) => (
              <div
                key={item.id || idx}
                className="bg-white rounded-2xl border border-stone-200/90 shadow-xs p-6 space-y-4 flex flex-col justify-between hover:border-stone-300 transition-colors"
              >
