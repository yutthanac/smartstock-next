...
### [2026-09-25] ปรับปรุงระบบวิเคราะห์คู่แข่งและความโปร่งใสของข้อมูล AI (Data Grounding & Truth Meter, AI Strategy Debate & UI Declutter)

1. **ปรับปรุงตำแหน่งเครื่องมือในแผนที่ (`InteractiveMapPicker.tsx`)**:
   - ย้ายปุ่มปรับขนาดรัศมี (`1 กม.`, `1.5 กม.`, `2 กม.`, `3 กม.`) ขึ้นไปไว้ในแถบเครื่องมือด้านบนคู่กับตัวกรองประเภทสถานที่ (`ร้านกาแฟ/คาเฟ่` / `ร้านค้าทั้งหมด`)
   - ยกเลิกแถบปรับรัศมีด้านล่างและ Drawer ซ้อน เพื่อลดการบดบังแผนที่และคลิกปรับได้ทันที

2. **มาตรวัดความจริงและความโปร่งใสของข้อมูล (Truth Meter & Data Grounding)**:
   - เพิ่มการแยกแยะสัดส่วนข้อมูลชัดเจนระหว่าง **🟢 ข้อมูลจริง (35%)** (พิกัด, ชื่อร้าน, ดาว, รีวิว Google Maps, สภาพอากาศสด) และ **🟡 แบบจำลอง AI (65%)** (เมนูยอดนิยม, ราคา Sweet Spot, เสียงจำลองผู้บริโภค)
   - เพิ่มแถบ Progress Bar 2 สี แสดงสัดส่วนอย่างโปร่งใส พร้อม Drawer ดูรายละเอียดที่มาข้อมูลแบบพับเก็บได้
   - เพิ่มป้ายกำกับแหล่งที่มาใน 6 มิติการวิเคราะห์ (`🟢 ข้อมูลจริง` vs `🟡 AI คาดการณ์`) พร้อมหมายเหตุแจ้งเตือนอย่างซื่อตรง ไม่ทำให้ผู้ใช้เข้าใจผิดว่าเป็นคอมเมนต์รายบุคคลจริง

3. **ระบบ AI ถกเถียงกลยุทธ์ 2 ขั้ว (Strategy Debate: ฝ่ายรุก vs ฝ่ายระวัง + Safe Action Plan)**:
   - **🌱 ฝ่ายรุก (Growth Strategist)**: นำเสนอโอกาสทางธุรกิจ ช่องว่างตลาด และเมนูสร้างยอดขาย
   - **🛡️ ฝ่ายระวัง (Devil's Advocate)**: ตรวจสอบความเสี่ยง ต้นทุนจม วัตถุดิบเน่าเสีย และระดับการแข่งขัน
   - **⚖️ แผนลงมือทำที่ปลอดภัย (Safe Action Plan)**: สรุปคำแนะนำการทดลองตลาดขนาดเล็กก่อนลงทุนจริง

4. **การจัดระเบียบหน้าจอและลดความรก (UI Declutter & Progressive Disclosure)**:
   - ซ่อนบทวิเคราะห์ SWOT และข้อติชมรายร้านไว้เริ่มต้น โดยให้เปิดดูผ่านปุ่ม `[✨ การวิเคราะห์ AI เชิงลึก 🟡 AI จำลอง]` ช่วยให้หน้าร้านคู่แข่งกระชับ สะอาดตา และไม่ลายตา
   - เพิ่มปุ่ม `[ย่อแผนที่]` / `[แสดงแผนที่]` เมื่อประมวลผลเสร็จ เพื่อคืนพื้นที่หน้าจอให้ผู้ใช้โฟกัสกับเนื้อหาบทวิเคราะห์ได้ทันที
   - มิติทั้ง 6 ถูกยุบซ่อนไว้เริ่มต้น (Collapsed by default) เพื่อให้ผู้ใช้เลือกอ่านเฉพาะเรื่องที่สนใจ
...
- [ ] **พยากรณ์ยอดขายตามสภาพอากาศและอีเวนต์ร่วมกับข้อมูลจริง**:
  - เมื่อสภาพอากาศฝนตก/แดดจัด AI จะตรวจดูว่าเมนูร้อน/เย็นตัวไหนของร้านที่ขายดีในช่วงเวลานั้น พร้อมคำนวณวัตถุดิบที่ต้องเตรียมล่วงหน้า
